...
<body>
   ...
   <h3>대기중인 견적</h3>
      <table class="table">
       ...
       <tbody>
          <c:forEach var="cons_esti" items="${w_conlist}" >     
               <tr align="center">
            ...
            <div class="block-27">
              <ul>
              	<c:if test="${pagevo.startPage != 1}">
	                <li><a href="${contextPath}/expertpage/con_wait.do?nowPage=${pagevo.startPage-1}&cntPerPage=${pagevo.cntPerPage}">&lt;</a></li>
	            </c:if>
	            <c:forEach begin = "${pagevo.startPage}" end = "${pagevo.endPage}" var="idx">
	                ...
	                <c:when test="${idx != pagevo.nowPage}">
	                <li><a href="${contextPath}/expertpage/con_wait.do?nowPage=${idx}&cntPerPage=${pagevo.cntPerPage}"> ${idx} </a></li>
	                </c:when>
	         <%--      
	                <li><a href="#">3</a></li>
	                <li><a href="#">4</a></li>
	              ...
	              <c:if test="${pagevo.endPage != pagevo.lastPage}">
	                <li><a href="${contextPath}/expertpage/con_wait.do.do?nowPage=${pagevo.endPage+1 }&cntPerPage=${pagevo.cntPerPage}">&gt;</a></li>
	              </c:if>
              </ul>
